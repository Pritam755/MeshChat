package com.meshchat.android.testhook

import android.content.Context
import android.content.Intent
import android.util.Log
import com.meshchat.android.favorites.FavoritesPersistenceService
import com.meshchat.android.features.file.FileUtils
import com.meshchat.android.features.voice.LiveVoiceEvent
...
import com.meshchat.android.features.voice.LiveVoiceCapture
import com.meshchat.android.identity.SecureIdentityStateManager
import com.meshchat.android.mesh.MeshService
import com.meshchat.android.mesh.PrivateMediaPreparation
import com.meshchat.android.mesh.TransferProgressManager
...
import com.meshchat.android.service.MeshForegroundService
...
import com.meshchat.android.ui.DataManager
import com.meshchat.android.ui.PrivateMediaRecipientResolver
...
object TestHookDriver {
    ...
    private suspend fun msgRecv(context: Context, intent: Intent): JSONObject {
        ...
        val startTime = System.currentTimeMillis()
        val mesh = mesh(context)
        val matches: (com.meshchat.android.model.BitchatMessage) -> Boolean = { msg ->
            msg.timestamp.time >= startTime &&
                msg.senderPeerID != mesh.myPeerID &&
                (contains == null || msg.content.contains(contains)) &&

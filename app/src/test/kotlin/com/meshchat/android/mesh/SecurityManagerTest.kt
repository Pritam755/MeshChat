...
import com.meshchat.android.noise.NoiseHandshakeProcessingResult
import com.meshchat.android.noise.NoisePeerIdentity
import com.meshchat.android.noise.NoiseSessionError
...
class SecurityManagerTest {
    ...
    fun `validatePacket - handles ANNOUNCE duplicates correctly`() {
        ...
        val packet1 = BitchatPacket(
            type = MessageType.ANNOUNCE.value,
            ttl = com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS, // 7u
            senderID = unknownPeerID,
            payload = payload
        )
        ...
        val packet2 = packet1.copy(ttl = (com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS - 1u).toUByte())
        ...
        val packet3 = packet1.copy(ttl = com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS)
    ...
    fun `handshake dedup entries expire by time and allow delayed retry`() = runBlocking {
        ...
        securityManager.cleanupOldData(
            System.currentTimeMillis() +
                com.meshchat.android.util.AppConstants.Security.KEY_EXCHANGE_DEDUP_TIMEOUT_MS + 1_000
        )

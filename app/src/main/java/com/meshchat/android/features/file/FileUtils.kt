package com.meshchat.android.features.file
...
object FileUtils {
     ...
     */
    fun messageTypeForMime(mime: String): com.meshchat.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.meshchat.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.meshchat.android.model.BitchatMessageType.Audio
            else -> com.meshchat.android.model.BitchatMessageType.File
        }
    }

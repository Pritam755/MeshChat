package com.meshchat.android.service
...
class MeshForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.meshchat.android.service.START"
        const val ACTION_STOP = "com.meshchat.android.service.STOP"
        const val ACTION_QUIT = "com.meshchat.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.meshchat.android.service.UPDATE_NOTIFICATION"
    ...
    private val unifiedMeshService: com.meshchat.android.mesh.MeshService?
    ...
    override fun onCreate() {
        super.onCreate()
        Log.i("MeshForegroundService", "==================== [STAGE 3: FOREGROUND SERVICE LIFECYCLE] ====================")
        Log.i("MeshForegroundService", "[SERVICE LIFECYCLE] onCreate() invoked")
        ...
        updateJob = scope.launch {
            com.meshchat.android.services.AppStateStore.peers
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.i("MeshForegroundService", "[SERVICE LIFECYCLE] onStartCommand(action=${intent?.action}, startId=$startId)")
        ...
        when (intent?.action) {
            ACTION_STOP -> {
                ...
                updateJob?.cancel()
                updateJob = null
                try { com.meshchat.android.services.MessageRouter.tryGetInstance()?.stopOutboxScheduler() } catch (_: Exception) { }
    ...
    override fun onDestroy() {
        Log.i("MeshForegroundService", "[SERVICE LIFECYCLE] onDestroy() invoked")
        updateJob?.cancel()
        updateJob = null

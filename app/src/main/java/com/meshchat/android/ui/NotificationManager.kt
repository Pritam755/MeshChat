...
import com.meshchat.android.service.ConversationNotificationReceiver
import com.meshchat.android.services.ContactDirectory
import com.meshchat.android.services.ConversationListPreferences
    ...
    companion object {
      ...
      private const val GEOHASH_SUMMARY_NOTIFICATION_ID = 998
        ...
        const val ACTION_REPLY_TO_CONVERSATION =
            "com.meshchat.android.action.REPLY_TO_CONVERSATION"
        const val ACTION_MARK_CONVERSATION_READ =
            "com.meshchat.android.action.MARK_CONVERSATION_READ"

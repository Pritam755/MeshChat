...
import com.meshchat.android.geohash.GeohashNostrPrivacyPolicy
import com.meshchat.android.geohash.LiveLocationPrivacyGate
import com.meshchat.android.nostr.GeohashMessageHandler
import com.meshchat.android.nostr.GeohashRepository
import com.meshchat.android.nostr.NostrBackgroundRuntime
import com.meshchat.android.nostr.NostrIdentityBridge
import com.meshchat.android.nostr.NostrProtocol
import com.meshchat.android.nostr.NostrRelayManager
import com.meshchat.android.nostr.NostrSubscriptionManager
import com.meshchat.android.nostr.PoWPreferenceManager
import com.meshchat.android.nostr.GeohashAliasRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.meshchat.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.meshchat.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.meshchat.android.geohash.ChannelID.Mesh)
    ...
    fun panicReset() {
        ...
        try { com.meshchat.android.nostr.NostrRelayManager.getInstance(getApplication()).clearAllOnPanic() } catch (_: Exception) {}
        try { com.meshchat.android.nostr.LocationNotesManager.getInstance().stop() } catch (_: Exception) {}
    }

    fun sendGeohashMessage(content: String, channel: com.meshchat.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.meshchat.android.model.BitchatMessage(
                    id = tempId,
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.meshchat.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.meshchat.android.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.meshchat.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.meshchat.android.geohash.ChannelID.Mesh -> {
            ...
            is com.meshchat.android.geohash.ChannelID.Location -> {
                if (locationChannelManager?.canUseSelectedLocationChannel(channel.channel) != true) {
                    ...
                    switchLocationChannel(com.meshchat.android.geohash.ChannelID.Mesh)
                    return
                }
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        val selectedLocation = selected as? com.meshchat.android.geohash.ChannelID.Location

...
class CommandProcessor(
    ...
    private fun handleActionCommand(
        ...
        if (parts.size > 1) {
            ...
            val isInLocationChannel = state.selectedLocationChannel.value is com.meshchat.android.geohash.ChannelID.Location
    ...
    private fun handlePayCommand(
        ...
        if (selectedPeer != null) {
            ...
            val isLocationChannel =
                state.selectedLocationChannel.value is com.meshchat.android.geohash.ChannelID.Location
    ...
    private fun addSystemMessage(content: String) {
        ...
        when {
            ...
            selectedLocationChannel is com.meshchat.android.geohash.ChannelID.Location -> {

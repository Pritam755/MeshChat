...
import com.meshchat.android.core.ui.component.sheet.BitchatSheetCenterTopBar
import com.meshchat.android.core.ui.component.sheet.LocalSheetDismiss
import com.meshchat.android.core.ui.component.sheet.BitchatSheetTitle
import com.meshchat.android.core.ui.component.sheet.BitchatSheetTopBar
import com.meshchat.android.favorites.FavoriteRelationship
import com.meshchat.android.favorites.FavoritesPersistenceService
import com.meshchat.android.geohash.ChannelID
import com.meshchat.android.identity.SecureIdentityStateManager
import com.meshchat.android.model.BitchatMessageType
import com.meshchat.android.ui.theme.BASE_FONT_SIZE
import com.meshchat.android.ui.theme.BitchatMotion
import com.meshchat.android.ui.theme.LocalBitchatPalette
import com.meshchat.android.ui.theme.colorForPeer
...
fun MeshPeerListSheet(
    ...
    val wifiAwareConnected by com.meshchat.android.wifiaware.WifiAwareController.connectedPeers.collectAsStateWithLifecycle()
                ...
                LazyColumn(
                    ...
                    when {
                        conversationStoreState is
                            com.meshchat.android.services.ConversationStoreState.Loading &&
                        ...
                        conversationStoreState is
                            com.meshchat.android.services.ConversationStoreState.Error &&
                            conversations.isEmpty() -> {

...
import com.meshchat.android.features.media.ImageUtils
import com.meshchat.android.ui.ComposerActionSurface
import com.meshchat.android.ui.ComposerIconSize
import java.io.File
...
fun ImagePickerButton(
    ...
    val takePictureLauncher = rememberLauncherForActivityResult(
        ...
        if (success && !path.isNullOrBlank()) {
            ...
            val outPath = com.meshchat.android.features.media.ImageUtils.downscalePathAndSaveToAppFiles(context, path)
    ...
    ComposerActionSurface(
        ...
        Icon(
            ...
            contentDescription = stringResource(com.meshchat.android.R.string.pick_image),
            tint = tint,

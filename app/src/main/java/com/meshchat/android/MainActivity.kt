...
import com.meshchat.android.geohash.LocationChannelManager
import com.meshchat.android.onboarding.BluetoothCheckScreen
import com.meshchat.android.onboarding.BluetoothStatus
import com.meshchat.android.onboarding.BluetoothStatusManager
import com.meshchat.android.onboarding.BatteryOptimizationManager
import com.meshchat.android.onboarding.BatteryOptimizationPreferenceManager
import com.meshchat.android.onboarding.BatteryOptimizationScreen
import com.meshchat.android.onboarding.BatteryOptimizationStatus
import com.meshchat.android.onboarding.BackgroundLocationPermissionScreen
import com.meshchat.android.onboarding.InitializationErrorScreen
import com.meshchat.android.onboarding.InitializingScreen
import com.meshchat.android.onboarding.LocationCheckScreen
import com.meshchat.android.onboarding.LocationStatus
import com.meshchat.android.onboarding.LocationStatusManager
import com.meshchat.android.onboarding.OnboardingCoordinator
import com.meshchat.android.onboarding.OnboardingState
import com.meshchat.android.onboarding.PermissionExplanationScreen
import com.meshchat.android.onboarding.PermissionManager
import com.meshchat.android.ui.nav.MeshChatNavHost
import com.meshchat.android.ui.ChatViewModel
import com.meshchat.android.ui.OrientationAwareActivity
import com.meshchat.android.ui.theme.MeshChatTheme
import androidx.navigation.compose.rememberNavController
import com.meshchat.android.wifiaware.WifiAwareController
import com.meshchat.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.meshchat.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.meshchat.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.meshchat.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.meshchat.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        meshService = com.meshchat.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        unifiedMeshService = com.meshchat.android.service.MeshServiceHolder.getUnifiedOrCreate(applicationContext)
    ...
    private fun checkBluetoothAndProceed() {
        ...
        val bleRequired = try { com.meshchat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        if (!bleRequired) {
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.meshchat.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun handleLocationEnabled() {
        ...
        com.meshchat.android.wifiaware.WifiAwareController.startIfPossible()
        checkBatteryOptimizationAndProceed()
    }
    ...
    private fun handleOnboardingComplete() {
        ...
        val bleRequired2 = try { com.meshchat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        when {
    ...
    private fun startMeshForegroundServiceBestEffort() {
        ...
        try {
            com.meshchat.android.service.MeshForegroundService.start(applicationContext)
    ...
    private fun initializeApp() {
        lifecycleScope.launch {
            try {
                ...
                com.meshchat.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.meshchat.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.meshchat.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.meshchat.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.meshchat.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.meshchat.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.meshchat.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.meshchat.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.meshchat.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.meshchat.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.meshchat.android.geohash.GeohashChannelLevel.REGION
                        else -> com.meshchat.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.meshchat.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.meshchat.android.geohash.ChannelID.Location(geohashChannel)

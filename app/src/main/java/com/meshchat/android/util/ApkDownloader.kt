...
internal fun downloadPhaseLabel(phase: ApkDownloader.DownloadPhase): Int = when (phase) {
    ApkDownloader.DownloadPhase.AwaitingConnectivity ->
        com.meshchat.android.R.string.prepare_apk_phase_awaiting_connectivity
    ApkDownloader.DownloadPhase.Retrying ->
        com.meshchat.android.R.string.prepare_apk_phase_retrying
    ApkDownloader.DownloadPhase.SelectingSource ->
        com.meshchat.android.R.string.prepare_apk_phase_selecting_source
    ApkDownloader.DownloadPhase.AwaitingNetworkRoute ->
        com.meshchat.android.R.string.prepare_apk_phase_awaiting_route
    ApkDownloader.DownloadPhase.Transferring ->
        com.meshchat.android.R.string.prepare_apk_phase_transferring
    ApkDownloader.DownloadPhase.VerifyingSignature ->
        com.meshchat.android.R.string.prepare_apk_phase_verifying_signature
}

package com.meshchat.android.onboarding
...
class PermissionManager(private val context: Context) {
    ...
    private fun shouldRequireWifiAwarePermission(): Boolean {
        ...
        val enabled = try {
            com.meshchat.android.ui.debug.DebugPreferenceManager.getWifiAwareEnabled(false)
        } catch (_: Exception) {
            false
        }
        ...
        return try {
            com.meshchat.android.wifiaware.WifiAwareSupport.isSupported(context)
        } catch (_: Exception) {
            false
        }
    }

...
internal class PrivateMediaTransferPreparer(
    ...
    private fun prepare(
        ...
        val maxPrivateFragments =
            com.meshchat.android.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
        val absolutePayloadUpperBound =
            maxPrivateFragments.toLong() *
                com.meshchat.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE.toLong()

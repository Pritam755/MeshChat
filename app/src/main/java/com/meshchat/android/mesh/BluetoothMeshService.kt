...
import com.meshchat.android.crypto.EncryptionService
import com.meshchat.android.model.BitchatMessage
import com.meshchat.android.model.AuthenticatedPeerState
import com.meshchat.android.model.PeerCapabilities
import com.meshchat.android.protocol.MessagePadding
import com.meshchat.android.model.RoutedPacket
import com.meshchat.android.model.IdentityAnnouncement
import com.meshchat.android.model.NoisePayload
import com.meshchat.android.model.NoisePayloadType
import com.meshchat.android.protocol.BitchatPacket
import com.meshchat.android.protocol.MessageType
import com.meshchat.android.protocol.SpecialRecipients
import com.meshchat.android.model.RequestSyncPacket
import com.meshchat.android.sync.GossipSyncManager
import com.meshchat.android.util.toHexString
import com.meshchat.android.services.VerificationService
import com.meshchat.android.service.TransportBridgeService
...
class BluetoothMeshService(private val context: Context) : TransportBridgeService.TransportLayer {
    ...
    companion object {
        ...
        private val MAX_TTL: UByte = com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS
        private const val PEER_DISCONNECT_GRACE_MS = com.meshchat.android.util.AppConstants.Mesh.PEER_DISCONNECT_GRACE_MS
    }
    ...
    private val privateMediaPreparer by lazy {
        PrivateMediaTransferPreparer(
            ...
            encrypt = { plaintext, peerID, authenticatedSession ->
                ...
                } catch (_: com.meshchat.android.noise.NoiseSessionError.SessionGenerationChanged) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: com.meshchat.android.noise.NoiseSessionError.SessionNotFound) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: com.meshchat.android.noise.NoiseSessionError.SessionNotEstablished) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: Exception) {
    ...
    private val serviceNotificationManager = com.meshchat.android.ui.NotificationManager(
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.meshchat.android.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.meshchat.android.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.meshchat.android.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
                } catch (_: Exception) { 0.01 }
            }
        )

        com.meshchat.android.service.MeshServiceHolder.setGossipManager(gossipSyncManager) { packet ->
    ...
    private fun setupDelegates() {
        ...
        peerManager.delegate = object : PeerManagerDelegate {
            override fun onPeerListUpdated(peerIDs: List<String>) {
                ...
                try { com.meshchat.android.services.AppStateStore.setTransportPeers("BLE", peerIDs) } catch (_: Exception) { }
            ...
            override fun onPeerRemoved(peerID: String) {
                ...
                try { com.meshchat.android.services.meshgraph.MeshGraphService.getInstance().removePeer(peerID) } catch (_: Exception) { }
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun updatePeerInfoFromVerifiedAnnouncement(peerID: String, nickname: String, noisePublicKey: ByteArray, signingPublicKey: ByteArray, isVerified: Boolean, capabilities: com.meshchat.android.model.PeerCapabilities?): Boolean {
            ...
            override fun decryptFromPeer(
                ...
                senderPeerID: String
            ): com.meshchat.android.noise.NoiseDecryptionResult? {
            ...
            override fun onAuthenticatedPeerStateReceived(
                ...
                authenticatedSession: com.meshchat.android.noise.AuthenticatedNoiseSession
            ) {
            ...
            override fun onMessageReceived(message: BitchatMessage) {
                ...
                if (
                    !com.meshchat.android.services.IncomingMessageAdmission
                ...
                if (delegate == null && message.isPrivate && message.sender != "system") {
                    try {
                        ...
                        if (senderPeerID != null) {
                            ...
                            val preview = com.meshchat.android.ui.NotificationTextUtils.buildPrivateMessagePreview(message)
            ...
            override fun onDeliveryAckReceived(messageID: String, peerID: String) {
                ...
                try {
                    com.meshchat.android.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        com.meshchat.android.model.DeliveryStatus.Delivered(peerID, Date())
                    )
                } catch (_: Exception) { }
            ...
            override fun onReadReceiptReceived(messageID: String, peerID: String) {
                try {
                    com.meshchat.android.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        com.meshchat.android.model.DeliveryStatus.Read(peerID, Date())
                    )
                } catch (_: Exception) { }
        ...
        override fun onPacketReceived(
            ...
            try {
                com.meshchat.android.ui.debug.DebugSettingsManager.getInstance().logIncoming(
                    packet = packet,
                    fromPeerID = peerID,
                    fromNickname = null,
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.meshchat.android.ui.debug.DebugSettingsManager.getInstance()
    ...
    fun startServices() {
        ...
        if (!isBleTransportEnabled()) {
            ...
            com.meshchat.android.service.MeshServiceHolder.stopSharedGossip("BLE")
            try { com.meshchat.android.services.AppStateStore.clearTransportPeers("BLE") } catch (_: Exception) { }
            try { com.meshchat.android.services.AppStateStore.clearTransportDirectPeers("BLE") } catch (_: Exception) { }
            return
        }
        if (terminated) {
        ...
        if (connectionManager.startServices()) {
            ...
            com.meshchat.android.service.MeshServiceHolder.startSharedGossip("BLE")
        } else {
    ...
    fun sendFileBroadcast(file: com.meshchat.android.model.BitchatFilePacket) {
        try {
    ...
    fun sendFilePrivate(recipientPeerID: String, file: com.meshchat.android.model.BitchatFilePacket) {
    ...
    fun prepareFilePrivate(
        ...
        file: com.meshchat.android.model.BitchatFilePacket,
        transferId: String,
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.meshchat.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.meshchat.android.model.NoisePayload(
                        type = com.meshchat.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { com.meshchat.android.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = com.meshchat.android.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(com.meshchat.android.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }

            try {
                // Create read receipt payload using NoisePayloadType exactly like iOS
                val readReceiptPayload = com.meshchat.android.model.NoisePayload(
                    type = com.meshchat.android.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = BitchatPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
                ...
                readReceiptRetrySender.enqueue(
                    ...
                    onComplete = { accepted ->
                        if (accepted) {
                            try {
                                com.meshchat.android.services.SeenMessageStore
        ...
        serviceScope.launch {
            try {
                ...
                val packet = BitchatPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS
                )
    ...
    fun sendBroadcastAnnounce() {
        serviceScope.launch {
            val nickname = try { com.meshchat.android.services.NicknameProvider.getNickname(context, myPeerID) } catch (_: Exception) { myPeerID }
            ...
            try {
                ...
                if (directPeers.isNotEmpty()) {
                    val gossip = com.meshchat.android.services.meshgraph.GossipTLV.encodeNeighbors(directPeers)
                    tlvPayload = tlvPayload + gossip
                }
                // Always update our own node in the mesh graph with the neighbor list we used
                try {
                    com.meshchat.android.services.meshgraph.MeshGraphService.getInstance()
    ...
    private fun getDirectPeerIDsForGossip(): List<String> {
        return try {
            ...
            try { com.meshchat.android.services.AppStateStore.setTransportDirectPeers("BLE", direct) } catch (_: Exception) { }
            val union = try {
                com.meshchat.android.services.AppStateStore.getDirectPeers().ifEmpty { direct }
     ...
     */
    fun getSessionState(peerID: String): com.meshchat.android.noise.NoiseSession.NoiseSessionState {
    ...
    private fun applyRouteIfAvailable(packet: BitchatPacket): BitchatPacket {
        return try {
            ...
            if (recipient != null && !recipient.contentEquals(SpecialRecipients.BROADCAST)) {
                ...
                val path = com.meshchat.android.services.meshgraph.RoutePlanner.shortestPath(
                    myPeerID,
                    destination
                )

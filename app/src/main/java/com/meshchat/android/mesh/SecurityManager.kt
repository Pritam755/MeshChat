...
import com.meshchat.android.noise.AuthenticatedNoiseSession
import com.meshchat.android.noise.NoiseDecryptionResult
...
class SecurityManager(private val encryptionService: EncryptionService, private val myPeerID: String) {
    ...
    companion object {
        ...
        private const val MESSAGE_TIMEOUT = com.meshchat.android.util.AppConstants.Security.MESSAGE_TIMEOUT_MS // 5 minutes (same as iOS)
        private const val CLEANUP_INTERVAL = com.meshchat.android.util.AppConstants.Security.CLEANUP_INTERVAL_MS // 5 minutes
        private const val MAX_PROCESSED_MESSAGES = com.meshchat.android.util.AppConstants.Security.MAX_PROCESSED_MESSAGES
        private const val MAX_PROCESSED_KEY_EXCHANGES = com.meshchat.android.util.AppConstants.Security.MAX_PROCESSED_KEY_EXCHANGES
        private const val KEY_EXCHANGE_DEDUP_TIMEOUT = com.meshchat.android.util.AppConstants.Security.KEY_EXCHANGE_DEDUP_TIMEOUT_MS
    }
    ...
    fun validatePacket(packet: BitchatPacket, peerID: String): Boolean {
        ...
        if (processedMessages.contains(messageID)) {
            ...
            val isFreshAnnounce = messageType == MessageType.ANNOUNCE &&
                    packet.ttl >= com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS
    ...
    suspend fun handleNoiseHandshake(routed: RoutedPacket): Boolean {
        ...
        try {
            ...
            if (result.establishedNow) {
                ...
                val isDirectIngress = packet.ttl == com.meshchat.android.util.AppConstants.MESSAGE_TTL_HOPS

package com.meshchat.watch.testhook
...
import com.meshchat.watch.mesh.WearMeshService
import com.meshchat.watch.service.WearMeshForegroundService
        ...
        return ok("favorite_status")
            ...
            .put(
                ...
                when (identity.favoriteIndicator) {
                    com.meshchat.watch.ui.FavoriteIndicator.Favorite -> "filled"
                    com.meshchat.watch.ui.FavoriteIndicator.FavoritedUs -> "outlined_orange"
                    com.meshchat.watch.ui.FavoriteIndicator.None -> "outlined"
                }
            )
    }

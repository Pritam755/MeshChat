 ...
 *
 *   adb shell am broadcast -a com.meshchat.watch.TEST_HOOK \
 *     --es cmd <command> --es id <cmd-id> [command extras...]
 *
 * Result is written to cache/testhook/results/<id>.json (readable via run-as com.meshchat.watch)
...
class WearTestHookReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION = "com.meshchat.watch.TEST_HOOK"

...
import com.meshchat.watch.ui.ChatScreen
import com.meshchat.watch.ui.DmScreen
import com.meshchat.watch.ui.NicknameSetupScreen
import com.meshchat.watch.ui.PeopleScreen
import com.meshchat.watch.ui.UserDetailScreen
import com.meshchat.watch.ui.VerificationCodeScreen
import com.meshchat.watch.ui.WearChatState
import com.meshchat.watch.ui.sendPrivateMessage
import com.meshchat.watch.ui.sendPublicMessage
import com.meshchat.watch.ui.theme.BitchatWearTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onResume() {
        super.onResume()
        com.meshchat.android.features.voice.LiveVoiceManager.getInstance(applicationContext)
...
internal fun WearNavHost(
    ...
    AnimatedContent(
        ...
        transitionSpec = {
            fadeIn(tween(com.meshchat.watch.ui.theme.BitchatMotion.EMPHASIZED_MS)) togetherWith
                fadeOut(tween(com.meshchat.watch.ui.theme.BitchatMotion.QUICK_MS))
        },
        ...
        when (current) {
            ...
            is WearScreen.TextInput -> {
                ...
                com.meshchat.watch.ui.TextInputScreen(
                    onSend = { text ->
                        mesh?.let { m ->

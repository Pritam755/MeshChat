package com.meshchat.watch.notification
...
import com.meshchat.watch.MainActivity
...
class WearNotificationCoordinator private constructor(context: Context) {
    ...
    companion object {
        const val EXTRA_OPEN_DM = "com.meshchat.watch.extra.OPEN_DM"
        const val EXTRA_PEER_ID = "com.meshchat.watch.extra.PEER_ID"
